            ...
            <Box className="flex min-h-screen">
                <Box className="flex-1 overflow-auto" sx={{ backgroundColor: 'background.default' }}>
                    <Box className="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
                        ...
                        {!selectedAttribute && (
                            <Typography variant="h6" className='mb-8 font-light' align='center'>
                                Welcome to the <b>Processes Explorer</b>. Please <b>search</b> and select an attribute to see related processes.
                            </Typography>
                        )}
                            ...
                            >
                                <Box className="flex items-center gap-2">
                                    ...
                                    <Typography variant='h6' className="font-semibold">
                                        Erroneous Attributes ({warnings.filter(warning => warning.Type === WarningType.Attribute).length})
                                    </Typography>
                                </Box>
                            </AccordionSummary>
                            <AccordionDetails
