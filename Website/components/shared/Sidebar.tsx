...
const Sidebar = ({ }: SidebarProps) => {
  ...
  return (
    <Box 
      className={`relative flex flex-col items-start h-screen transition-all duration-300 ${
        isMobile ? 'w-sidebar-expanded shadow-lg' : (isOpen ? 'w-sidebar-expanded' : 'w-sidebar')
      }`}
      sx={{
        borderRight: 1,
