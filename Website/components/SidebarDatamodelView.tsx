...
export const SidebarDatamodelView = ({ }: ISidebarDatamodelViewProps) => {
    ...
    const NavItem = ({ group }: INavItemProps) => {
        ...
        return (
            <Collapsible
                ...
                className={`group/collapsible mx-1 ${isSelected ? "bg-sidebar-accent border-blue-500" : "border-transparent"} rounded-md transition-colors w-full`}
            >
                        ...
                        <div className="flex flex-col w-full gap-1 pl-4 py-1">
                            {group.Entities.map(entity => (
                                <div
                                    ...
                                    onClick={() => {
                                        dataModelDispatch({ type: "SET_SELECTED", payload: group.Name });
    ...
    return (
        <div className="flex flex-col">
            <h2 className="my-1 p-2 font-semibold">Data viewer</h2>
