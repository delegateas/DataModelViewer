...
const InsightsView = ({ }: InsightsViewProps) => {
    ...
    return (
        <Box className="my-6">
            <Box className="p-6 mb-8 rounded-2xl relative flex items-center h-full" sx={{ 
